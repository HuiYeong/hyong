...
class pure_pursuit:
    ...
    def odom_callback(self, msg):
        self.is_odom = True
        odom_quaternoion = (msg.pose.pose.orientation.x, msg.pose.pose.orientation.y, msg.pose.pose.orientation.z, msg.pose.pose.orientation.w)
        _,_,self.vehicle_yaw = euler_from_quaternion(odom_quaternoion)
        self.current_postion.x = msg.pose.pose.orientation.x
        self.current_postion.y = msg.pose.pose.orientation.y

    def amcl_callback(self, msg):
        self.is_amcl = True
        amcl_quaternoion = (msg.pose.pose.orientation.x, msg.pose.pose.orientation.y, msg.pose.pose.orientation.z, msg.pose.pose.orientation.w)
        _,_,self.vehicle_yaw = euler_from_quaternion(amcl_quaternoion)
        self.current_postion.x = msg.pose.pose.orientation.x
        self.current_postion.y = msg.pose.pose.orientation.y
